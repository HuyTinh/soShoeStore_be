...
public class VNPAYConfig {
    ...
    public static String md5(String message) throws NoSuchAlgorithmException {
        return hashing(MessageDigest.getInstance("MD5"), message);
    }

    public static String Sha256(String message) throws NoSuchAlgorithmException {
        return hashing(MessageDigest.getInstance("SHA-256"), message);
    }

    public static String hashing(MessageDigest mD, String message){
        String digest = null;
        try {
